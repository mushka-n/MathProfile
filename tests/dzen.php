...
<body>
   ...
   <div class="menu" id="menu">
        ...
        <div class="contaner">
            ...
            <div class="huge">
                ...
                <div class="huge-block">
                    <input type="text" class="huge-answer" id="user_answer" placeholder="Ваш ответ"><label for="huge_answer_10" class="huge-answer-label">Ваш ответ</label>
                </div>


                <button class="button" id="check_answer">Сдать задание</button>
    ...
    <form action="../index.php" method="POST" class="blitz-finish">
