   ...
   <div class="menu" id="menu">
    ...
    <div class="theory">
        ...
        <div class="example">
          ...
          <p><em>Решение:</em> собственно, все, что нужно знать &ndash; определение диагонали и понятие больше-меньше.</p>
        ...
        <div class="example">
          <h2>Пример №2</h2>
          <p>Найдите площадь треугольника.</p>
        ...
        <div class="example">
          <h2>Пример №3</h2>
          <p>Найдите площадь многоугольника</p>
          <img src="pics/313.jpg" alt="" class="theory-image">
          <p><em>Решение:&nbsp;</em>разобьем многоугольник на удобные фигуры и найдем их площади.</p>
        ...
        <div class="example">
          <h2>Пример №4</h2>
          <p>Найти площадь многоугольника.</p>
          <img src="pics/316.jpg" alt="" class="theory-image">
          <p><em>Решение:&nbsp;</em>можно найти площадь вычитанием, как и в предыдущих заданиях.</p>
        ...
        <div class="example">
          <h2>Пример №5</h2>
          <p>Найдите градусную меру угла АВС.</p>
          <img src="pics/315.jpg" alt="" class="theory-image">
          <p><em>Решение:&nbsp;</em>Точка А имеет нецелые координаты, однако теорема о вписанном и центральном углах позволяет легко решить задачу.</p>
        ...
        <div class="example">
          <h2>Пример №6</h2>
          <p>Найдите тангенс угла.</p>
          <img src="pics/315.jpg" alt="" class="theory-image">
          <p><em>Решение:&nbsp;</em>выделим смежный острый угол.</p>
